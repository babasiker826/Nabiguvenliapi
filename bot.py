...
# API Endpoint'leri
API_ENDPOINTS = {
    'tc': {'url': 'https://api2.nabi.totalh.net/api/tc?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile temel bilgi sorgulama'},
    'tc2': {'url': 'https://api2.nabi.totalh.net/api/tc2?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile detaylı bilgi sorgulama'},
    'yas': {'url': 'https://api2.nabi.totalh.net/api/yas?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile yaş hesaplama'},
    'burc': {'url': 'https://api2.nabi.totalh.net/api/burc?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile burç bilgisi sorgulama'},
    'iban': {'url': 'https://api2.nabi.totalh.net/api/iban?iban={iban}', 'method': 'GET', 'desc': 'IBAN numarası ile banka bilgisi sorgulama'},
    'aile': {'url': 'https://api2.nabi.totalh.net/api/aile?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile aile bilgisi sorgulama'},
    'es': {'url': 'https://api2.nabi.totalh.net/api/es?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile eş bilgisi sorgulama'},
    'cocuk': {'url': 'https://api2.nabi.totalh.net/api/cocuk?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile çocuk bilgisi sorgulama'},
    'erkekcocuk': {'url': 'https://api2.nabi.totalh.net/api/erkekcocuk?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile erkek çocuk bilgisi sorgulama'},
    'kizcocuk': {'url': 'https://api2.nabi.totalh.net/api/kizcocuk?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile kız çocuk bilgisi sorgulama'},
    'kardes': {'url': 'https://api2.nabi.totalh.net/api/kardes?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile kardeş bilgisi sorgulama'},
    'anne': {'url': 'https://api2.nabi.totalh.net/api/anne?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile anne bilgisi sorgulama'},
    'baba': {'url': 'https://api2.nabi.totalh.net/api/baba?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile baba bilgisi sorgulama'},
    'ded': {'url': 'https://api2.nabi.totalh.net/api/ded?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile dede bilgisi sorgulama'},
    'nine': {'url': 'https://api2.nabi.totalh.net/api/nine?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile nine bilgisi sorgulama'},
    'sulale': {'url': 'https://api2.nabi.totalh.net/api/sulale?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile sülale bilgisi sorgulama'},
    'soyagaci': {'url': 'https://api2.nabi.totalh.net/api/soyagaci?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile soy ağacı bilgisi sorgulama'},
    'sulaledenhalasorgu': {'url': 'https://api2.nabi.totalh.net/api/sulaledenhalasorgu?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile sülaleden hala sorgulama'},
    'sulaledenamcasorgu': {'url': 'https://api2.nabi.totalh.net/api/sulaledenamcasorgu?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile sülaleden amca sorgulama'},
    'sulaledendayisorgu': {'url': 'https://api2.nabi.totalh.net/api/sulaledendayisorgu?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile sülaleden dayı sorgulama'},
    'sulaledenteyzesorgu': {'url': 'https://api2.nabi.totalh.net/api/sulaledenteyzesorgu?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile sülaleden teyze sorgulama'},
    'kuzen': {'url': 'https://api2.nabi.totalh.net/api/kuzen?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile kuzen bilgisi sorgulama'},
    'yegen': {'url': 'https://api2.nabi.totalh.net/api/yegen?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile yeğen bilgisi sorgulama'},
    'adres': {'url': 'https://api2.nabi.totalh.net/api/adres?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile adres bilgisi sorgulama'},
    'haneadres': {'url': 'https://api2.nabi.totalh.net/api/haneadres?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile hane adres bilgisi sorgulama'},
    'tcgsm': {'url': 'https://api2.nabi.totalh.net/api/tcgsm?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile GSM numarası sorgulama'},
    'gsmtc': {'url': 'https://api2.nabi.totalh.net/api/gsmtc?gsm={gsm}', 'method': 'GET', 'desc': 'GSM numarası ile TC kimlik numarası sorgulama'},
    'operator': {'url': 'https://api2.nabi.totalh.net/api/operator?numara={numara}', 'method': 'GET', 'desc': 'Telefon numarası ile operatör bilgisi sorgulama'},
    'adsoyad': {'url': 'https://api2.nabi.totalh.net/api/adsoyad?ad={ad}&soyad={soyad}&il={il}&ilce={ilce}', 'method': 'GET', 'desc': 'Ad, soyad, il ve ilçe ile kişi sorgulama'},
    'adsoyadpro': {'url': 'https://api2.nabi.totalh.net/api/adsoyadpro?ad={ad}&soyad={soyad}', 'method': 'GET', 'desc': 'Ad ve soyad ile detaylı kişi sorgulama'},
    'profil': {'url': 'https://api2.nabi.totalh.net/api/profil?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile profil bilgisi sorgulama'},
    'tamamileagaci': {'url': 'https://api2.nabi.totalh.net/api/tamamileagaci?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile tam aile ağacı sorgulama'},
    'tcvegsm': {'url': 'https://api2.nabi.totalh.net/api/tcvegsm?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile TC ve GSM bilgisi sorgulama'},
    'adresvegsm': {'url': 'https://api2.nabi.totalh.net/api/adresvegsm?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile adres ve GSM bilgisi sorgulama'},
    'tumiletisim': {'url': 'https://api2.nabi.totalh.net/api/tumiletisim?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile tüm iletişim bilgisi sorgulama'},
    'cocuksayisi': {'url': 'https://api2.nabi.totalh.net/api/cocuksayisi?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile çocuk sayısı sorgulama'},
    'kardessayisi': {'url': 'https://api2.nabi.totalh.net/api/kardessayisi?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile kardeş sayısı sorgulama'},
    'ailebuyuklugu': {'url': 'https://api2.nabi.totalh.net/api/ailebuyuklugu?tc={tc}', 'method': 'GET', 'desc': 'TC kimlik numarası ile aile büyüklüğü sorgulama'},
    'log': {'url': 'https://api2.nabi.totalh.net/api/log?site={site}', 'method': 'GET', 'desc': 'Site adı ile log bilgisi sorgulama'}
}
